...
# Writing figures
```{r}
ggsave(plot = fig1, filename = "analysis/trait_bites/trait_figures/fig1.tiff", width = 6, height = 4)
ggsave(plot = forest_plot, filename = "analysis/trait_bites/trait_figures/fig2.tiff", width = 6, height = 4)
ggsave(plot = fig3a, filename = "analysis/trait_bites/trait_figures/fig3a.tiff", width = 6, height = 4)
ggsave(plot = fig3b, filename = "analysis/trait_bites/trait_figures/fig3b.tiff", width = 6, height = 4)
...
ggsave(plot = fig3, filename = "analysis/trait_bites/trait_figures/fig3.tiff", width = 5, height = 7)
```
